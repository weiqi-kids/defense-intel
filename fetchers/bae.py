...
class BaeFetcher(CompanyFetcher):
    """BAE Systems 爬蟲"""

    company_id = "bae"
    company_name = "BAE Systems"
    news_url = "https://www.baesystems.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.baesystems.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from BAE Systems")
        return documents
