...
class RheinmetallFetcher(CompanyFetcher):
    """Rheinmetall 爬蟲"""

    company_id = "rheinmetall"
    company_name = "Rheinmetall"
    news_url = "https://www.rheinmetall.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.rheinmetall.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Rheinmetall")
        return documents
