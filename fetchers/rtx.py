...
class RtxFetcher(CompanyFetcher):
    """RTX Corporation 爬蟲"""

    company_id = "rtx"
    company_name = "RTX Corporation"
    news_url = "https://www.rtxcorporation.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.rtxcorporation.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from RTX Corporation")
        return documents
