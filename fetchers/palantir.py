...
class PalantirFetcher(CompanyFetcher):
    """Palantir Technologies 爬蟲"""

    company_id = "palantir"
    company_name = "Palantir Technologies"
    news_url = "https://www.palantirtechnologies.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.palantirtechnologies.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Palantir Technologies")
        return documents
