...
class ElbitFetcher(CompanyFetcher):
    """Elbit Systems 爬蟲"""

    company_id = "elbit"
    company_name = "Elbit Systems"
    news_url = "https://www.elbitsystems.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.elbitsystems.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Elbit Systems")
        return documents
