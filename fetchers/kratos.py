"""
Kratos Defense & Security Solutions 官網爬蟲
"""
...
class KratosFetcher(CompanyFetcher):
    """Kratos Defense & Security Solutions 爬蟲"""

    company_id = "kratos"
    company_name = "Kratos Defense & Security Solutions"
    news_url = "https://www.kratosdefense&securitysolutions.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.kratosdefense&securitysolutions.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Kratos Defense & Security Solutions")
        return documents
