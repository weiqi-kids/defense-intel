...
class GeneralDynamicsFetcher(CompanyFetcher):
    """General Dynamics 爬蟲"""

    company_id = "general_dynamics"
    company_name = "General Dynamics"
    news_url = "https://www.generaldynamics.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.generaldynamics.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from General Dynamics")
        return documents
...
if __name__ == "__main__":
    fetcher = GeneralDynamicsFetcher()
