...
class LeonardoFetcher(CompanyFetcher):
    """Leonardo 爬蟲"""

    company_id = "leonardo"
    company_name = "Leonardo"
    news_url = "https://www.leonardo.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.leonardo.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Leonardo")
        return documents
