...
class HanwhaAeroFetcher(CompanyFetcher):
    """Hanwha Aerospace 爬蟲"""

    company_id = "hanwha_aero"
    company_name = "Hanwha Aerospace"
    news_url = "https://www.hanwhaaerospace.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.hanwhaaerospace.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Hanwha Aerospace")
        return documents
