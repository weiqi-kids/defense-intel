...
class ThalesFetcher(CompanyFetcher):
    """Thales 爬蟲"""

    company_id = "thales"
    company_name = "Thales"
    news_url = "https://www.thales.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Thales")
        return documents
